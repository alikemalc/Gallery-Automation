...
{
    public partial class bmgüncelle : Form
    {
        public bmgüncelle()
        {
            InitializeComponent();
        ...
        OleDbConnection con;
        private void bmgüncelle_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                baglanti.Open();
                SqlCommand cmd = new SqlCommand("update musteri1 set tcno='" + bunifuMaterialTextbox1.Text + "',isim='" + bunifuMaterialTextbox2.Text + "',soyisim='" + bunifuMaterialTextbox3.Text + "',tel='" + bunifuMaterialTextbox7.Text + "',il='" + metroComboBox1.Text + "',ilce='" + metroComboBox2.Text + "',adreskalan='" + bunifuMaterialTextbox6.Text + "',postakodu='" + bunifuMaterialTextbox5.Text + "'where müsterino='" + bunifuMaterialTextbox8.Text + "'", baglanti);
