...
{
    public partial class karacsil : Form
    {
        public karacsil()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand cmd = new SqlCommand("delete from kiralıkarac1 where aracno=@id", baglanti);
        ...
        private void karacsil_Load(object sender, EventArgs e)
        {
