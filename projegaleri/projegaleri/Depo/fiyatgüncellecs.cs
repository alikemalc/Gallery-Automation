...
{
    public partial class fiyatgüncellecs : Form
    {
        public fiyatgüncellecs()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                baglanti.Open();
                SqlCommand cmd = new SqlCommand("update satilikarac1 set satisfiyati='" + bunifuMaterialTextbox3.Text + "'where aracno='" + bunifuMaterialTextbox1.Text + "'", baglanti);
